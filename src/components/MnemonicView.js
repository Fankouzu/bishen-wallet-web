        ...
        <Box className={classes.main}>
              ...
              >
                <TabPanel value={value} index={0}>
                  <Typography variant="h4">
                    {props.state.mnemonic_zh.replace(/ /g,'')}
                  </Typography>                    
                  <Typography align={'center'}>
                    <CopyToClipboard text={props.state.mnemonic_zh}>
                      <Button
                        size="small"
                ...
                <TabPanel value={value} index={1}>
                  <Typography variant="h5">
                    {props.state.mnemonic_en}
                  </Typography>                    
                  <Typography align={'center'}>
                    <CopyToClipboard text={props.state.mnemonic_en}>
                      <Button
                        size="small"
                        className={classes.copyButton}
                        startIcon={<FileCopyIcon />}
          ...
          <Button
            ...
            to={{
              ...
              state: { 
                useMnemonic: props.state.useMnemonic,
                mnemonic_lang: props.state.mnemonic_lang
              }
            }}
          >
            下一步
